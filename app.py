                    ...
                    if create_draft:
                        ...
                        if validation_errors:
                            ...
                            try:
                                ...
                                # Product creation never depends on images. A draft can be created
                                # with zero images, and image failures are handled as non-blocking warnings.
                                ...
                                # Google Form / Drive images are optional. Fetch each independently so
                                # one missing or inaccessible file does not prevent the draft from existing.
                                for url in photo_urls:
                                    try:
                                ...
                                # Extra images uploaded directly in the app are optional too.
                                ...
                                attached_count = 0
                                # Stage and attach one image at a time so a bad image does not block
                                # the remaining images or change the draft's Created status.
