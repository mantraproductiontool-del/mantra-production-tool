...
PHOTOROOM_BACKGROUND_COLOR = "#D4CDC5"  # warm light greige close to the current Mantra catalog look
    ...
    if google_config is None:
        ...
        if intake_df.empty:
            ...
            if pending_df.empty:
                ...
                # Only the Tags checkbox answer supplies tags for form-based drafts.
                # Empty answers (including older submissions) must stay empty.
                submitted_tags = split_list_cell(row_value(selected_row, exact=("Tags",)))
                ...
                with st.form(f"shopify_product_review_form_{selected_sheet_row}"):
                    ...
                    st.text_input(
                        "Tags selected in Google Form",
                        value=", ".join(submitted_tags),
